...
\begin{document}
  ...
  \cite{elgendy2020deep, liu2016ssd}. One-stage detectors like Single Shot Detector (SSD) and You Only Look Once (YOLO
  skip the region proposal to achieve real-time detection speed \cite{elgendy2020deep}. In general, one-stage detectors
  sacrifices some accuracy for speed \cite{elgendy2020deep}.
