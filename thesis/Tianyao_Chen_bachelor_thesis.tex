...
\begin{document}
  ...
  Deep learning is a class of machine learning algorithms that build neural networks with more than one layer between
  input and output \cite{burkov2019hundred, zhang2018definition}. Deep learning builds complex representations by
