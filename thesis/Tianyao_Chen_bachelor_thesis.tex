...
accessibility \cite{drap2015underwater}. However, the need to study deep-water sites is in high demand, as the threats
...
\cite{elgendy2020deep, geron2019hands, planche2019hands}. The traditional Pascal VOC metric uses mAP@0.5, which means
...
was published. YOLO is also a one-stage real-time detector similar to SSD. YOLOv1 \cite{redmon2016you} introduces the
