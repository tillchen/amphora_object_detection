...
\begin{document}
  ...
  The model is trained on Google Colaboratory \cite{colab} with a GPU runtime, and the training takes 2 hours and 40
  minutes to reach the peak mAP result at step 8621.

  \section{Evaluation}

  The main metric $mAP_{coco}$ (see section \ref{sec:generalobjectdetection}) is 0.238, while the traditional $mAP_{50}$ is 0.503.
