...
\begin{document}
  ...
  R-CNN has the following disadvantages \cite{elgendy2020deep, girshick2014rich}:

  \begin{itemize}
    \item The FPS is very low. The selective search algorithm proposes about 2000 RoIs, which is every computationally
    expensive as the CNN has to process each proposal.
    \item The training is multi-stage, complex, expensive, and not end-to-end. It involves training three components
