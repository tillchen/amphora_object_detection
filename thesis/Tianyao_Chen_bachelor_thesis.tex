...
\end{figure}
  ...
  learning, and three major object detector families. Detecting underwater amphoras is a challenging task,
  We have then trained an SSD model based on a very small and
  low-resolution dataset, and yet still managed to achieve 0.238 for $mAP_{coco}$ and 0.5392 for $mAP_{50}$. We hope this
  paper can serve as a proof of concept for future studies to improve upon.

  % \cite{mccarthy20193d,pasquet2017amphora} define three classes as amphoras are often broken
  % \cite{kisantal2019augmentation} increase image resolution
