...
\begin{document}
  ...
  Like many measures that are named after the packages that held them, amphoras were also a semi-standard unit of liquid
  ...
  The structurally strongly egg-like shape and the high volume to weight ratio made amphoras very efficient packages
  ...
  Amphoras' various shapes and markings - which changed over time and varied by region, producer, contents, and brand
