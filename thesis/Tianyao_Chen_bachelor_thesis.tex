...
\begin{document}
  ...
  %fully convolutional network (FCN) \cite{long2015fully}. FCNs contain only convolutional layers
  % and pooling layers, which means input images can have arbitrary sizes \cite{long2015fully}.
